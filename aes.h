...
void encrypt_2_plain(uint8_t *plaintext1, uint8_t *plaintext2, uint8_t *seed_key);
void encrypt_2_key(uint8_t *plaintext1, uint8_t *plaintext2, uint8_t *seed_key1, uint8_t *seed_key2);
